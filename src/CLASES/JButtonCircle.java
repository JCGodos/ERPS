 ...
 * @author Mouse
 * Clase original de javaface-elblogdelprogramador
 */
public class JButtonCircle extends JButton {
    
    private Image image = null;
    private ImageIcon icono = new ImageIcon(getClass().getResource("/IMAGENES/default.jpg"));
